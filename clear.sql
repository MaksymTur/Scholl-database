...
DROP FUNCTION IF EXISTS study_start CASCADE;
DROP FUNCTION IF EXISTS work_start CASCADE;
DROP FUNCTION IF EXISTS bell_begin_time CASCADE;
DROP FUNCTION IF EXISTS bell_end_time CASCADE;
DROP FUNCTION IF EXISTS was_at_lecture CASCADE;
DROP FUNCTION IF EXISTS is_studying CASCADE;
DROP FUNCTION IF EXISTS is_working CASCADE;
DROP FUNCTION IF EXISTS get_lessons CASCADE;